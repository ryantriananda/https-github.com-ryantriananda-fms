  ...
  const SectionHeader = ({ icon: Icon, title, subtitle }: { icon: any, title: string, subtitle?: string }) => (
    <div className="flex items-center gap-3 mb-6">
        ...
        <div>
            ...
            {subtitle && <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-1">{subtitle}</p>}
        </div>
    </div>
  );
                ...
                <div className="space-y-8">
                    ...
                    <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <div className="bg-orange-50 text-orange-600 px-3 py-1 rounded-lg text-[9px] font-black uppercase tracking-widest flex items-center gap-1">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-1">EVOLUSI TARIF SEWA KAMAR</p>
                                </div>
                            </div>
                            {!isView && (
                                <button className="bg-blue-50 text-blue-600 px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-blue-100 transition-all flex items-center gap-2">
                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-1">DATA PEMBAYARAN SEWA & UTILITAS LISTRIK</p>
                                </div>
                            </div>
                            {!isView && !isAddingTransaction && (
                                <button onClick={() => setIsAddingTransaction(true)} className="bg-black text-white px-4 py-2 rounded-full text-[9px] font-black uppercase tracking-widest hover:bg-gray-900 transition-all flex items-center gap-2 shadow-lg">
                        ...
                        {isAddingTransaction && (
                            <div className="mb-6 p-4 bg-gray-50 rounded-2xl border border-dashed border-gray-300 animate-in slide-in-from-top-2">
                                ...
                                <div className="flex justify-end gap-2">
                                    <button onClick={() => setIsAddingTransaction(false)} className="px-4 py-2 bg-white text-gray-500 rounded-lg text-[9px] font-bold uppercase hover:bg-gray-100">BATAL</button>
                                    <button onClick={handleAddTransaction} className="px-4 py-2 bg-black text-white rounded-lg text-[9px] font-bold uppercase hover:bg-gray-800">SIMPAN RECORD</button>
                                </div>
                            </div>
                        )}
