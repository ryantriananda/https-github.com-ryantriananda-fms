...
interface RequestARKPageProps {
    data: AssetRecord[];
    onSave: (data: AssetRecord) => void;
    onImportClick: () => void;
}

export const RequestARKPage: React.FC<RequestARKPageProps> = ({ data, onSave, onImportClick }) => {
            ...
            <AddStockModal
                ...
                onSaveStationeryRequest={(data) => {
                    const newReq: AssetRecord = {
                        id: Date.now(),
                        transactionNumber: `TRX/ARK/${Date.now()}`,
